    ...
    $.widget("ui.draggable", $.ui.mouse, {
        ...
        _generatePosition: function(event) {
            ...
            if (this.originalPosition) { //If we are not dragging yet, we won't check for options
                ...
                if (o.grid) {
                    //Check for grid elements set to 0 to prevent divide by 0 error cauĐăng nhậpvalid argument errors in IE (see ticket #6950)
    ...
    $.extend(Datepicker.prototype, {
        ...
        _getInst: function(target) {
            try {
                ...
                throw 'MisĐăng nhậpstance data for this datepicker';
            }
        },
            ...
            _ajaxSettings: function(anchor, event, ui) {
                ...
                return $.extend({}, ajaxOptions, {
                    error: function(xhr, status) {
                        try {
                            // PasĐăng nhậpdex avoid a race condition when this method is
