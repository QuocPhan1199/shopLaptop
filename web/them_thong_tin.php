...
// giờ mình phải lấy được cái id trên url xuống -- mà khoan để anh coi đoạn ni đã
		if (!empty($ten_khach_hang)) {
			if ($ma_khach_hang == '') { // ry hắn vô đây rồi nì nghĩa là mã đang trống để thử in session ra đây coi  
				...
				<div class="panel-body">
					<div class="form-group">
					  <label for="usr">Họ Và Tên:</label>
					   <input type="text" name="ma_khach_hang" value="<?=$ma_khach_hang?>" >
